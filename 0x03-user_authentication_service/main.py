#!/usr/bin/env python3
"""Simple end-to-end  integration test for `app.py`...
"""
import requests
...
def profile_unlogged() -> None:
    """Tests retrieving profile information in logged out state...
    """
...
def profile_logged(session_id: str) -> None:
    """Tests retrieving profile information in logged in state...
    """
    url = "{}/profile".format(BASE_URL)
    req_cookies = {
